...
> New: A static GPU Datacenter Economics dashboard now lives in `dashboard/`. It is ready for GitHub Pages/Netlify hosting with a pluggable data source (GitHub raw JSON, Notion proxy, or any HTTPS feed). See `dashboard/README.md` for setup.
